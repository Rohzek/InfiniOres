...
public class DepletedShovelBlock extends Block
{
	public Block regenerate;
	
	public DepletedShovelBlock(Block block) 
	{
		super(Properties.of(Material.SNOW).harvestTool(ToolType.SHOVEL).requiresCorrectToolForDrops());
