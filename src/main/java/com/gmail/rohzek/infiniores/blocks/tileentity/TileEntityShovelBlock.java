...
public class TileEntityShovelBlock extends TileEntity implements ITickableTileEntity
{
private static Random random = new Random();
	...
	public TileEntityShovelBlock() 
	{
		super(InfiniOresTileEntities.SHOVEL_BLOCK_TILE_ENTITY.get());
	}
	
	public TileEntityShovelBlock(TileEntityType<?> tileEntity, DepletedLog log) 
	{
		super(tileEntity);
